  ...
  try
    try
      ...
      begin
        ...
        try
          HTTP.Post('http://localhost:8081/produto/saldo', Payload);
        except
          ...
          begin
            ...
            begin
              ...
              AResponseInfo.ContentText := 'Saldo insuficiente para o produto ID = ' + ProdutoID.ToString;
            end
            else
            begin
              AResponseInfo.ResponseNo := E.ErrorCode;
          ...
          begin
            AResponseInfo.ResponseNo := 500;
            AResponseInfo.ContentText := 'Erro inesperado ao baixar saldo: ' + E.Message;
            Exit;
          end;
        end;
